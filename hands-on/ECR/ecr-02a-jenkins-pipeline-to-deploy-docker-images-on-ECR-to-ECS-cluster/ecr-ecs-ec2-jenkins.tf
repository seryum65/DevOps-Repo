...
locals {
  github-email    = "cloudengineer.yusuf@gmail.com"   # you need to change this line
  github-username = "seryum65"               # you need to change this line
  github-token    = "xxxxxxxxxxxx"                       # you need to change this line
  key_pair        = "firstkey"                       # you need to change this line
  pem_key_address = "/home/seryum65/Desktop/AWS-Devops/DevOps/firstkey.pem" # you need to change this line
}
